...
public class CredentialsTest
{
    ...
    public void testWrongPassword()
    {
        ...
        User user = new User("User1Name","User1", "123456", "What is your favourite color", "Red", null, null);
        accessUsers.insertNewUser(user);
    ...
    public void testCorrectSecurityAnswer()
    {
        ...
        User user = new User("a1","User1", "123456", "What is your favourite color", "Red", null, null);
        accessUsers.insertNewUser(user);
        String userNameInput = "User1";
    ...
    public void testIncorrectSecurityAnswer()
    {
        ...
        User user = new User("asd","User1", "123456", "What is your favourite color", "Red", null, null);
        accessUsers.insertNewUser(user);
        String userNameInput = "User1";
    ...
    public void userNameNotFound()
    {
        ...
        User user = new User("da da","User1", "123456", "What is your favourite color", "Red", null, null);
