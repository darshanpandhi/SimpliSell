...
public class AccessAdsIT {
    ...
    public void testFilterAdsByType()
    {
        ...
        List<Ad> allAds = accessAds.getAllAds();
        List<Ad> offeringAds = accessAds.filterAdsByType(allAds, AdType.OFFERING);
        List<Ad> wantedAds = accessAds.filterAdsByType(allAds, AdType.WANTED);
