...
public class AdPersistenceStub implements AdPersistence
{
    ...
    public AdPersistenceStub()
    {
        ...
        Ad newAd = new Ad(0, adOwner, adType, category, title, description, price, 0, date);
        ads.add(newAd);
        ...
        newAd = new Ad(1, adOwner, adType, category, title, description, price, 0, date);
        ads.add(newAd);
        ...
        newAd = new Ad(2, adOwner, adType, category, title, description, price, 0, date);
        ads.add(newAd);
        ...
        newAd = new Ad(3, adOwner, adType, category, title, description, price, 0, date);
        ads.add(newAd);
        ...
        newAd = new Ad(4, adOwner, adType, category, title, description, price, 0, date);
        ads.add(newAd);
    }
