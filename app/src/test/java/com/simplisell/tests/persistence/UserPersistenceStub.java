...
public class UserPersistenceStub implements UserPersistence
{
    ...
    public UserPersistenceStub()
    {
        ...
        User user;
        user = new User("Bob Saget", "Bob", "123456", "What is your favourite color", "Red", 0);
        users.add(user);
        user = new User("Allice Wonderland", "Allice", "123456", "What is your favourite color", "Green", 0);
        users.add(user);
        user = new User("Jay Petr", "Jay", "123456", "What is your favourite color", "Blue", 0);
        users.add(user);
    }
