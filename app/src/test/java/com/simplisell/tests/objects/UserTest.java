...
public class UserTest
{
    ...
    public void testNewAdvitiserUser()
    {
        ...
        User User = new User("go as", "user1", "123456", "What is your favourite color", "Red", "user@email.com",
				"204-512-3213", false);
        assertNotNull(User);
    ...
    public void testAdminUser()
    {
        ...
        User userAdmin = new User("bad admin", "user1", "123456", "What is your favourite color", "Red", "", "", true);
